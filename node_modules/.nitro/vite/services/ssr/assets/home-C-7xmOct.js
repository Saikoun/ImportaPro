import { t as AppShell } from "./app-shell-D6XvdBNe.js";
import { i as onSessionChange, r as getSession } from "./session-D1W-TbwR.js";
import { t as logo_importapro_default } from "./logo-importapro-BYtWj2tW.js";
import { t as AnimatedCounter } from "./animated-counter-CplA4Btm.js";
import { a as listHistory, c as onHistoryChange, n as formatAr } from "./history-CmpTOKK3.js";
import { useEffect, useMemo, useState } from "react";
import { Link, useNavigate } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
import { ArrowRight, ArrowUpRight, Bell, Calculator, ClipboardList, FileText, History, Landmark, Lightbulb, Package, Percent, Sparkles, Tag, TrendingUp, Truck } from "lucide-react";
...
function HomePage() {
	...
	return /* @__PURE__ */ jsx(AppShell, {
		...
		action: /* @__PURE__ */ jsxs(Link, {
			...
			children: [/* @__PURE__ */ jsx(Bell, { className: "h-5 w-5" }), /* @__PURE__ */ jsx("span", { className: "absolute right-2 top-2 h-1.5 w-1.5 rounded-full bg-primary" })]
		}),
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsx(IntroCard, {}),
				/* @__PURE__ */ jsxs("div", {
					className: "relative",
					children: [/* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute -inset-0.5 rounded-[28px] bg-linear-to-r from-primary to-primary-glow opacity-25 blur-md" }), /* @__PURE__ */ jsxs("div", {
						className: "relative overflow-hidden rounded-[28px] border border-border-strong bg-card p-6",
						children: [
							/* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute -right-16 -top-16 h-40 w-40 rounded-full bg-primary/30 blur-3xl animate-float-orb" }),
							/* @__PURE__ */ jsxs("div", {
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						/* @__PURE__ */ jsx(ArrowUpRight, { className: "h-4 w-4 text-primary-glow" })
					]
				}),
				/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [records.length === 0 && /* @__PURE__ */ jsx(EmptyState, {}), records.slice(0, 4).map((r) => /* @__PURE__ */ jsxs(Link, {
						to: "/calcul",
						search: { id: r.id },
						...
						children: [
							/* @__PURE__ */ jsx("span", {
								...
								children: /* @__PURE__ */ jsx(Package, { className: "h-5 w-5" })
							}),
							/* @__PURE__ */ jsxs("div", {
								className: "min-w-0 flex-1",
...
function IntroCard() {
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [/* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute -left-16 -bottom-16 h-40 w-40 rounded-full bg-primary/20 blur-3xl" }), /* @__PURE__ */ jsxs("div", {
			className: "relative",
			children: [
				/* @__PURE__ */ jsxs("span", {
					...
					children: [/* @__PURE__ */ jsx(Sparkles, { className: "h-3 w-3" }), " Découvrir"]
				}),
				/* @__PURE__ */ jsxs("h3", {
				...
				/* @__PURE__ */ jsxs(Link, {
					...
					children: ["Commencer un calcul", /* @__PURE__ */ jsx(ArrowRight, { className: "h-4 w-4" })]
				})
			]
		})]
	});
...
function DailyTipCard() {
	...
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [/* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute -right-10 -top-10 h-28 w-28 rounded-full bg-primary/15 blur-2xl" }), /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsx("span", {
				...
				children: /* @__PURE__ */ jsx(Lightbulb, { className: "h-5 w-5" })
			}), /* @__PURE__ */ jsxs("div", {
				className: "min-w-0 flex-1",
				children: [/* @__PURE__ */ jsx("p", {
